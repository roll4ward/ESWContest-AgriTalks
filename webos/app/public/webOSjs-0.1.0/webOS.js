          ...
          var o = function (t, o) {
              if (!t && o)
                try {
                  ...
                  console.error(
                    "Unable to parse appinfo.json file for " + appID
                  ),
                    e && e();
                }
              else e && e();
    ...
    webOS.deviceInfo = function (e) {
      if (this.device) e(this.device);
        ...
        try {
          ...
          (this.device.modelName = t.modelName),
            (this.device.modelNameAscii = t.modelNameAscii),
            (this.device.version = t.platformVersion),
            (this.device.versionMajor = t.platformVersionMajor),
            (this.device.versionMinor = t.platformVersionMinor),
            (this.device.versionDot = t.platformVersionDot),
            (this.device.sdkVersion = t.platformVersion),
            (this.device.screenWidth = t.screenWidth),
            (this.device.screenHeight = t.screenHeight);
        } catch (o) {
        ...
        webOS.platform.tv
          ? webOS.service.request(
              "luna://com.webos.service.tv.systemproperty",
              {
                ...
                onSuccess: function (t) {
                  if (
                    ((i.device.modelName = t.modelName || i.device.modelName),
                    (i.device.modelNameAscii =
                      t.modelName || i.device.modelNameAscii),
                    (i.device.sdkVersion = t.sdkVersion || i.device.sdkVersion),
                    (i.device.uhd = "true" === t.UHD),
                    ...
                    for (
                      var o = i.device.version.split("."),
                        s = ["versionMajor", "versionMinor", "versionDot"],
                        n = 0;
                      n < s.length;
                      n++
                    )
          ...
          : (webOS.platform.watch &&
              (this.device.modelName = this.device.modelNameAscii =
                "webOS Watch"),
            e(this.device));
      }
    };
    ...
    webOS.notification = {
      showToast: function (e, t) {
        ...
        if (webOS.platform.legacy || webOS.platform.open) {
          ...
          o.length > 60 &&
            console.warn(
              "Toast notification message is longer than recommended. May not display as intended"
            );
          var b = { sourceId: s, message: o, stale: l, noaction: c };
          i && i.length > 0 && (b.iconUrl = i),
            c ||
              (a
                ? (b.onclick = { target: a })
                : (b.onclick = { appId: n, params: r })),
            (this.showToastRequest = webOS.service.request(
              "palm://com.webos.notification",
              {
                ...
                onFailure: function (e) {
                  console.error("Failed to create toast: " + JSON.stringify(e)),
                    t && t();
                },
              }
            ));
      ...
      removeToast: function (e) {
        if (webOS.platform.legacy || webOS.platform.open)
          ...
          this.removeToastRequest = webOS.service.request(
            "palm://com.webos.notification",
            { method: "closeToast", parameters: { toastId: e } }
          );
      },
      ...
      showDashboard: function (e, t) {
        if (webOS.platform.legacy || webOS.platform.open) {
          ...
          return (
            t && o.document.write(t),
            o.PalmSystem && o.PalmSystem.stageReady(),
            o
          );
        }
      ...
      l = function (e, t, o, s) {
        window.PalmSystem &&
          (o &&
            ...
            (s = null),
            console.warn(
              "webOSLog called with invalid format: keyVals must be an object"
            )),
          t ||
            e == a ||
            console.warn(
              "webOSLog called with invalid format: messageId was empty"
            ),
          o && (o = JSON.stringify(o)),
          window.PalmSystem.PmLogString
            ? e == a
              ? window.PalmSystem.PmLogString(e, null, null, s)
              : window.PalmSystem.PmLogString(e, t, o, s)
            : console.error(
                "Unable to send log; PmLogString not found in this version of PalmSystem"
              ));
      };
  ...
  (function () {
    function e(e, t) {
      (this.uri = e),
        (t = t || {}),
        t.method &&
          ("/" != this.uri.charAt(this.uri.length - 1) && (this.uri += "/"),
          (this.uri += t.method)),
        "function" == typeof t.onSuccess && (this.onSuccess = t.onSuccess),
        "function" == typeof t.onFailure && (this.onFailure = t.onFailure),
        "function" == typeof t.onComplete && (this.onComplete = t.onComplete),
        (this.params = "object" == typeof t.parameters ? t.parameters : {}),
        (this.subscribe = t.subscribe || !1),
        this.subscribe && (this.params.subscribe = t.subscribe),
        this.params.subscribe && (this.subscribe = this.params.subscribe),
        (this.resubscribe = t.resubscribe || !1),
        this.send();
    }
    (e.prototype.send = function () {
      ...
      var t = this;
      (this.bridge.onservicecallback = this.callback =
        function (o) {
          var i;
          if (!t.cancelled) {
            try {
            ...
            (i.errorCode || 0 == i.returnValue) && t.onFailure
              ? (t.onFailure(i),
                t.resubscribe &&
                  t.subscribe &&
                  (t.delayID = setTimeout(function () {
                    t.send();
                  }, e.resubscribeDelay)))
              : t.onSuccess && t.onSuccess(i),
      ...
      (e.prototype.cancel = function () {
        (this.cancelled = !0),
          this.resubscribeJob && clearTimeout(this.delayID),
          this.bridge && (this.bridge.cancel(), (this.bridge = void 0));
      }),
      (e.prototype.toString = function () {
        return "[LS2Request]";
      }),
      (e.resubscribeDelay = 1e4),
      (webOS.service = {
        ...
        if (webOS && webOS.platform && webOS.platform.watch) {
          var i,
            ...
            n = function (e) {
              webOS.service.request("luna://com.webos.settingsservice", {
                ...
                onFailure: function (e) {
                  console.error(
                    "Failed to get system VoiceReadOut settings: " +
                      JSON.stringify(e)
                  );
                },
              });
            ...
            r = function (e) {
              webOS.service.request("luna://com.webos.settingsservice", {
                ...
                onFailure: function (e) {
                  console.error(
                    "Failed to get system localeInfo settings: " +
                      JSON.stringify(e)
                  );
                },
              });
            ...
            a = function (e) {
              webOS.service.request("luna://com.webos.settingsservice", {
                ...
                onFailure: function (e) {
                  console.error(
                    "Failed to get system speechRate settings: " +
                      JSON.stringify(e)
                  );
                },
              });
          ...
          var l = function (e) {
              webOS.service.request("luna://com.webos.settingsservice", {
                ...
                onFailure: function (e) {
                  console.error(
                    "Failed to get system AudioGuidance settings: " +
                      JSON.stringify(e)
                  );
                },
              });
            ...
            c = function () {
              webOS.service.request("luna://com.webos.service.tts", {
                ...
                onFailure: function (e) {
                  console.error(
                    "Failed to readAlertMessage: " + JSON.stringify(e)
                  );
                },
              });
            };
